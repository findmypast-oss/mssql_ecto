defmodule Ecto.Integration.JoinsTest do
  ...
  test "right joins with missing entries" do
    ...
    %Permalink{id: plid1} =
      TestRepo.insert!(%Permalink{url: "1", post_id: pid2})
  ...
  test "has_many through association join" do
    ...
    assert [{^p1, ^u2}, {^p1, ^u1}, {^p1, ^u1}, {^p2, ^u2}] =
             TestRepo.all(query)
  end
  ...
  test "nested assoc" do
    ...
    %Comment{id: cid2} =
      TestRepo.insert!(%Comment{text: "2", post_id: pid1, author_id: uid2})

    %Comment{id: cid3} =
      TestRepo.insert!(%Comment{text: "3", post_id: pid2, author_id: uid2})
  ...
  test "nested assoc with missing entries" do
    ...
    %Comment{id: cid2} =
      TestRepo.insert!(%Comment{text: "2", post_id: pid1, author_id: nil})

    %Comment{id: cid3} =
      TestRepo.insert!(%Comment{text: "3", post_id: pid3, author_id: uid2})
