defmodule MssqlEcto.CreateTableTest do
  ...
  test "create table with options" do
    ...
    assert execute_ddl(create) ==
      [~s|CREATE TABLE "posts" ("id" int identity(1,1), "created_at" datetime2, PRIMARY KEY ("id")) WITH FOO=BAR|]
  end
  ...
  test "create table with composite key" do
    ...
    assert execute_ddl(create) == ["""
    CREATE TABLE "posts" ("a" int, "b" int, "name" nvarchar(255), PRIMARY KEY ("a", "b"))
    """ |> remove_newlines]
  end
